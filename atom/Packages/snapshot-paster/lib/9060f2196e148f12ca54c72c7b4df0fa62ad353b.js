(function() {
  ...
  module.exports = {
    activate: function() {
      return atom.workspaceView.command("snapshot-paster:paste", (function(_this) {
        return function() {
          return _this.paste();
        };
      })(this));
    ...
    paste: function() {
      ...
      if (!image.isEmpty()) {
        ...
        return fsp.writeFileSync(atom.project.getPath() + "/test.png", image.toPng(), 'base64');
      }
    }
  };
